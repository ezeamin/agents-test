Sourced from [this repo](https://github.com/pipecat-ai/pipecat-examples/tree/main/p2p-webrtc/voice-agent) but modified it to use all AWS (Transcribe, Polly, Bedrock).
